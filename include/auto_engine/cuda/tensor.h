...
void split(const f64* src, const base::Shape& src_shape, const std::vector<f64*>& dsts, const std::vector<std::reference_wrapper<const base::Shape>>& dsts_shapes, u32 d);
